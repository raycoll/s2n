...
int main(int argc, char **argv)
{
    ...
    conn->secure.cipher_suite->active_record_alg = &s2n_record_alg_rc4_sha;
    ...
    EXPECT_SUCCESS(conn->secure.cipher_suite->active_record_alg->cipher->set_decryption_key(&conn->secure.client_key, &key_iv));
    EXPECT_SUCCESS(conn->secure.cipher_suite->active_record_alg->cipher->set_encryption_key(&conn->secure.server_key, &key_iv));
